...
from PyQt5.QtWidgets import (QApplication, QWidget, QVBoxLayout,
                             ...
                             QFrame, QStackedLayout, QTabWidget, QHBoxLayout, QShortcut, QKeySequenceEdit, QSplitter)

from PyQt5.QtGui import QIcon, QWindow, QImage, QKeySequence, QClipboard
...
class App(QFrame):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Jake Grigorian's Web Browser")
    ...
    def CreateApp(self):
        ...
        self.setWindowIcon(QIcon("jake-260nw-632552729.ico"))
